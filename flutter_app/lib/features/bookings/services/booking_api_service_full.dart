...
class BookingApiService {
  ...
  Future<BookingListResponse> getBookings({
    ...
    // WARNING: Bookings API endpoints do not exist in the current backend
    // This functionality needs to be implemented in the backend first
    throw UnimplementedError('Bookings API not implemented in backend. Implement /api/v1/bookings endpoints first.');
  }
